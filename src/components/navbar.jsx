...
export default function Navbar(){
    ...
    return( 
            <div className="w-11/12 h-20 pt-10 z-20  top-0 mx-auto mb-3 " >
                ...
                <button className="max800:hidden  min800:order-3 mr-5 min800 right-0 " onClick={() => setMobile(!Mobile)}>
                {Mobile ? <ImCross className="min620:text-2xl"/> : <FaBars className="min620:text-2xl"/>}
                </button>
                ...
                <li className="text-xl cursor-pointer md1000:text-sm min800:p-5 min800:text-xxl" onClick={() => navigate("/sale")}>Sale</li>
                </div>
                </ul>
